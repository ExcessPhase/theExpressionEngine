...
#CXXFLAGS=-g -DDEBUG -march=native -ffast-math -I $(BOOST_ROOT)/include $(shell llvm-config --cxxflags) -fexceptions -MMD -MP -std=c++17 -fsanitize=undefined -fno-inline -O0 -fno-omit-frame-pointer -Wno-dangling-else
CXX=clang++
#CXX=g++-13
