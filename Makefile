...
CXXFLAGS=-march=native -ffast-math -I $(BOOST_ROOT)/include $(shell llvm-config-20 --cxxflags) -fexceptions -MMD -MP -std=c++17 -Wno-dangling-else -Wno-nan-infinity-disabled
CXXFLAGS+=-O3 -DNDEBUG
