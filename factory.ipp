...
template<
	bool BTHREADED,
	double(*PMATH)(double),
	llvm::Intrinsic::ID EID,
	const char AC[],
	typename factory<BTHREADED>::exprPtr (factory<BTHREADED>::*CREATE)(const typename factory<BTHREADED>::exprPtr&) const
>
...
template<
	...
	const char ACOP[],
	const char ACNAME[],
	llvm::Value* (*CreateICmpSLT)(llvm::IRBuilderBase&, llvm::Value*, llvm::Value*),
	typename factory<BTHREADED>::exprPtr (factory<BTHREADED>::*less)(const typename factory<BTHREADED>::exprPtr&_p0, const typename factory<BTHREADED>::exprPtr&_p1) const,
	typename FUNCTOR
>
struct shift:expression<BTHREADED>
{
	typedef typename expression<BTHREADED>::ptr ptr;
	shift(const ptr&_p0, const ptr&_p1)
		:expression<BTHREADED>({_p0, _p1}, expression<BTHREADED>::eInteger)
	{	if (!std::all_of(
			this->m_sChildren.begin(),
			this->m_sChildren.end(),
...
#include "binary.h"
	...
	{	static constexpr char acOP[] = "-";
		static constexpr char acName[] = "sub";
		typedef arithmetic<
			BTHREADED,
			acOP,
			acName,
			[](llvm::IRBuilder<>&_rB, llvm::Value*_pL, llvm::Value*_pR, const llvm::Twine&_rN) -> llvm::Value*
			{	return _rB.CreateFSub(_pL, _pR, _rN);
			},
			[](llvm::IRBuilder<>&_rB, llvm::Value*_pL, llvm::Value*_pR, const llvm::Twine&_rN) -> llvm::Value*
			{	return _rB.CreateSub(_pL, _pR, _rN);
			},
			&factory<BTHREADED>::subtraction,
			std::minus<void>
		> type;
		if (_p0->isZero())
			return negation(_p1);
	...
	{	static constexpr char acOP[] = "*";
		static constexpr char acName[] = "mult";
		typedef arithmetic<
			BTHREADED,
			acOP,
			acName,
			[](llvm::IRBuilder<>&_rB, llvm::Value*_pL, llvm::Value*_pR, const llvm::Twine&_rN) -> llvm::Value*
			{	return _rB.CreateFMul(_pL, _pR, _rN);
			},
			[](llvm::IRBuilder<>&_rB, llvm::Value*_pL, llvm::Value*_pR, const llvm::Twine&_rN) -> llvm::Value*
			{	return _rB.CreateMul(_pL, _pR, _rN);
			},
			&factory<BTHREADED>::multiplication,
			std::multiplies<void>
		> type;
		if (_p0->isOne())
			return _p1;
	...
	{	static constexpr char acOP[] = "/";
		static constexpr char acName[] = "div";
		typedef arithmetic<
			BTHREADED,
			acOP,
			acName,
			[](llvm::IRBuilder<>&_rB, llvm::Value*_pL, llvm::Value*_pR, const llvm::Twine&_rN) -> llvm::Value*
			{	return _rB.CreateFDiv(_pL, _pR, _rN);
			},
			[](llvm::IRBuilder<>&_rB, llvm::Value*_pL, llvm::Value*_pR, const llvm::Twine&_rN) -> llvm::Value*
			{	return _rB.CreateSDiv(_pL, _pR, _rN);
			},
			&factory<BTHREADED>::division,
			std::divides<void>
		> type;
		if (_p0->isZero())
			return _p0;
	...
	{	static constexpr char acOP[] = "<<";
		...
		return theExpressionEngine::expression<BTHREADED>::template create<
			theExpressionEngine::shift<
				BTHREADED,
				acOP,
				acName,
				[](llvm::IRBuilderBase&_r, llvm::Value*_p0, llvm::Value*_p1)
				{	return _r.CreateShl(_p0, _p1);
				},
